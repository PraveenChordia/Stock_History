...
# We add '.NS' at end of each stock to get Data of NSE, alternatively we can add '.BSE' to get data from BSE.
...
'''
data = yf.download(symbols, '2022-05-01')['Adj Close'][-90:]
failed_symbols = pd.DataFrame({'Failed': list(yf.multi.shared._ERRORS.keys())})
